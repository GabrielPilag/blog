...
public class PostService {
	...
	public List<Post> getAllPostsFilterByTitle(String title) {
	...
	public List<Post> getAllPostsFilterByCategory(String category) {
		return getAllPosts().stream()
				.filter(post -> post.getCategory().contains(category))
				.collect(Collectors.toList());
	}

	public List<Post> getAllPostsFilterByTitleAndCategory(String title, String category) {
		return getAllPosts().stream()
